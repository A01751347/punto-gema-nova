            ...
            <aside className="relative w-64 bg-[#F2EFE9] border-r border-[#E6E0D9] hidden md:flex flex-col flex-shrink-0 shadow-lg z-20">
                ...
                <nav className="flex-1 mt-6 px-4 space-y-2 pb-24">
                  ...
                  ${isSelected
                                        ...
                                        : 'text-[#2c4a52] hover:bg-white/80 hover:text-[#1f3940]'
                                    }
                  focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2c4a52]/30
                `}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-[#2c4a52]/10 bg-[#F2EFE9]">
                    <Link
                        href="/"
                        className="text-xs font-bold uppercase tracking-wider text-[#2c4a52]/70 hover:text-[#2c4a52] flex items-center gap-2"
                    >
