        ...
        <Link href={`/tienda/${product.slug}`} className="group cursor-pointer block">
            <div className="aspect-[4/5] bg-white overflow-hidden mb-5 md:mb-6 relative hover:shadow-xl transition-all duration-500 rounded-xl">
                ...
                <div className="absolute bottom-0 left-0 w-full p-4 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    <span className="w-full inline-flex items-center justify-center font-medium rounded-lg px-6 py-3 bg-white text-[#1a1a1a] hover:bg-[#1a1a1a] hover:text-white shadow-lg text-sm transition-colors duration-200">
                        Ver Detalles
                    </span>
                </div>
            </div>
